...
import 'package:untitled/model/popular.dart';
  ...
  Widget _buildItem(BuildContext context, int index) {
    ...
    return Container(
      decoration: BoxDecoration(
        borderRadius: radius,
        border: Border.all(color: const Color.fromARGB(255, 249, 246, 246), width: 2),
        color: isActive ? const Color.fromARGB(255, 199, 140, 14) : const Color.fromARGB(255, 199, 140, 14),
      ),
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Text(
            data.category,
            style: TextStyle(
              color: isActive ? const Color.fromARGB(255, 254, 239, 239) : const Color(0xFF101010),
              fontSize: 16,
...
class MostPopularTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        const Text('Most Popular', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Color.fromARGB(255, 195, 193, 193))),
        TextButton(
