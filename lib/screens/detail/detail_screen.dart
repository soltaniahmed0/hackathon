...
class _ShopDetailScreenState extends State<ShopDetailScreen> {
            ...
            CustomScrollView(
              slivers: [
                SliverAppBar(
                  ...
                  leading: IconButton(
                    icon: Image.asset('assets/icons/african.jpg', scale: 2),
  ...
  List<Widget> _buildDescription() {
    return [
      ...
      const Text(
        "  The subject of this stamp is African Liberty Day, numbered 671, with dimensions of 22x36 mm. It was issued on 15/04/1959, with a total issuance of 122,500 stamps. This stamp belongs to the commemorative series and was printed using the typography process. It carries a value of 40 millimes and features a drawing by Hatem EL MEKKI.",
      ),
    ];
  }
            ...
            child: InkWell(
              ...
              onTap: () {
                Navigator.push(context,
                    ...
                    MaterialPageRoute(builder: (c) => CardPaymentPage()));
              },
              child: Row(
